...
//
// L1 deposit (Bitcoin → Enoch) lives in DepositView, accessed from
// the Home screen action row. Receive is L2-only — keeps this
// screen focused on the "instant" Enoch path.
//
